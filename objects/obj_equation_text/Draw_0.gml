...
draw_set_alpha(0.5);
draw_roundrect_ext(x - _half_display_width - equation_text_display_border, y - equation_text_display_height - (equation_text_display_border * 2), x + _half_display_width + equation_text_display_border, y, 15, 15, false);
