...
//Destroy when done
if (equation_text_letters >= equation_text_length) && global.key_select && string_length(equation_text_input) > 0 && equation_text_equation_solution == real(equation_text_input)
{
	keyboard_string = "";
	instance_destroy();
