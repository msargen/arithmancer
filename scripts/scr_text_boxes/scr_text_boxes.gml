...
function scr_help_text_box(_text, _x_coordinate, _y_coordinate, _symbol, _offset=0, _arrow=true)
{
	...
	// draw the box
	draw_sprite_ext(spr_text_box_side, 0, _text_x_center - ceil(_text_width / 2), _text_y_center, 1, 1, 0, c_white, _opacity);
	draw_sprite_ext(spr_text_box_middle, 0, _text_x_center, _text_y_center, ceil(_text_width / 2), 1, 0, c_white, _opacity);
	draw_sprite_ext(spr_text_box_side, 0,  _text_x_center + ceil(_text_width / 2), _text_y_center, -1, 1, 0, c_white, _opacity);
	
	// draw text
	scr_draw_set_text(c_white, global.menu_font, fa_center, fa_middle);
	draw_text(_text_x_center - ceil(_sym_width / 2), _text_y_center, _text);
	draw_sprite(_symbol, 0, _text_x_center + ceil(_text_base / 2), _text_y_center);
}