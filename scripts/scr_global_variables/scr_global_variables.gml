...
// Blocky monotype font drawn for better looking equations
global.monotype_font = font_add_sprite(spr_monotype_font, ord("!"), false, 0);

// Font from popular block game for reference use
global.block_game_font = font_add_sprite(spr_block_game_font, ord(" "), true, 1);

// Font for menus
global.menu_font = font_add_sprite(spr_menu_font, ord(" "), true, 0);
